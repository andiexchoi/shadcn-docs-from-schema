...
*Originally written April 2025, proposing the transition from Do's & Don'ts lists to narrative format for Amazon Selling Partner Services mobile component documentation. This document is the intellectual foundation for the template and prompt architecture in this tool.*

---

## The problem with Do's and Don'ts lists

The standard two-column Do's and Don'ts format is scannable but shallow. Related guidelines get fragmented across bullets with no context linking them. A designer reading the list knows *what* to do, but not *why* — and without the why, they can't make a good judgment call when the situation doesn't perfectly match the rule.
...
- **Editorial guidelines:** specific character limits, capitalization rules, punctuation — concrete enough to act on without follow-up questions
