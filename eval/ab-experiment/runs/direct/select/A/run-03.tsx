...
const TIMEZONES = [
  ...
  { value: "Atlantic/Reykjavik", label: "Monrovia, Reykjavik", offset: "UTC+00:00" },
  ...
  { value: "Europe/Paris", label: "Brussels, Copenhagen, Madrid, Paris", offset: "UTC+01:00" },
  { value: "Europe/Warsaw", label: "Sarajevo, Skopje, Warsaw, Zagreb", offset: "UTC+01:00" },
  ...
  { value: "Asia/Baku", label: "Baku, Tbilisi, Yerevan", offset: "UTC+04:00" },
  ...
  { value: "Asia/Shanghai", label: "Beijing, Chongqing, Hong Kong, Urumqi", offset: "UTC+08:00" },
            ...
            <SelectPrimitive.Viewport className="max-h-[260px] overflow-y-auto p-1">
              {filtered.length === 0 ? (
                ...
                filtered.map((tz) => (
                  ...
                  >
                    <span className="mr-2 shrink-0 rounded bg-muted px-1.5 py-0.5 text-xs font-mono text-muted-foreground">
                      {tz.offset}
                    </span>
