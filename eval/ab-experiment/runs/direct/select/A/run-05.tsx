      ...
      >
        ...
        <SelectPrimitive.Portal>
          <SelectPrimitive.Content
            ...
            sideOffset={4}
            className={cn(
              "relative z-50 min-w-[var(--radix-select-trigger-width)] max-w-[min(520px,var(--radix-select-trigger-width)*2)] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md",
          ...
          >
            {/* Search bar — not inside Viewport so it's sticky */}
            ...
            <SelectPrimitive.Viewport className="max-h-64 overflow-y-auto p-1">
              {filtered.length === 0 ? (
                ...
                filtered.map((tz) => (
                  ...
                  >
                    <span className="shrink-0 rounded bg-muted px-1.5 py-0.5 text-xs font-mono text-muted-foreground w-[90px] text-center">
                      {tz.offset}
                    </span>
